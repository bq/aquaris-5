...
{0x64, 0x48}, //AGSAT
{0x66, 0x90}, //wht_th2
{0x67, 0x42}, //wht_gain  Dark (0.4x), Normal (0.75x)
...
{0x20, 0x04},	//SHARP_Negative
{0x21, 0x02},	//SHARP_Positive
...
void HI704_night_mode(kal_bool enable)
{
	    ...
	    if(HI704_sensor.banding == AE_FLICKER_MODE_50HZ)
    {
	   ...
	   HI704_write_cmos_sensor(0x84, 0x3d);
	   HI704_write_cmos_sensor(0x85, 0x62);
	   HI704_write_cmos_sensor(0x86, 0x00);
	   HI704_write_cmos_sensor(0x87, 0xfa);
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    HI704_write_cmos_sensor(0x20, 0x05);
    HI704_write_cmos_sensor(0x21, 0x03);
    HI704_write_cmos_sensor(0x80, 0x00);
    ...
    HI704_Set_Mirror_Flip(IMAGE_NORMAL);
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    HI704_write_cmos_sensor(0x67, 0xF0);
    HI704_write_cmos_sensor(0x68, 0x30);	

    HI704_write_cmos_sensor(0x03, 0x13);
    HI704_write_cmos_sensor(0x20, 0x05);//5
    HI704_write_cmos_sensor(0x21, 0x04);//4//4
    HI704_write_cmos_sensor(0x80, 0x00);
    HI704_write_cmos_sensor(0x90, 0x04);//5
    HI704_write_cmos_sensor(0x91, 0x03);// 3
...
BOOL HI704_set_param_wb(UINT16 para)
{
    ...
    case AWB_MODE_AUTO:
		...
		HI704_write_cmos_sensor(0x83, 0x4a);                                 
...
BOOL HI704_set_param_exposure(UINT16 para)
{
    ...
    case AE_EV_COMP_00:  // +0 EV
        HI704_write_cmos_sensor(0x40,0x88);//05
        break;    
...
UINT32 HI704YUVSetVideoMode(UINT16 u2FrameRate)
{
    ...
    if(u2FrameRate == 30) u2FrameRate = 10;
